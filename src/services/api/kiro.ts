...
export const kiroApi = {
  ...
  startPKCELogin: async (
    ...
    return apiClient.post<KiroPKCEStartResponse>('/v0/management/auth/kiro/login/pkce/start', {
      provider,
      region,
    });
  },
  ...
  startDeviceLogin: async (region?: string): Promise<KiroDeviceStartResponse> => {
    return apiClient.post<KiroDeviceStartResponse>('/v0/management/auth/kiro/login/device/start', {
      region,
    });
  },
